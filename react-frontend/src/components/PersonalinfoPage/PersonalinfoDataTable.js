...
const PersonalinfoDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    ...
    const pTemplate1 = (rowData, { rowIndex }) => <p >{rowData.surname}</p>
    ...
    return (
        <DataTable value={items} onRowClick={onRowClick} scrollable rowHover paginator rows={10}>
            <Column field="surname" header="surname" body={pTemplate1} style={{ minWidth: "8rem" }} />
            <Column field="address" header="address" body={pTemplate2} style={{ minWidth: "8rem" }} />
            <Column field="avatar" header="Avatar" body={avatarTemplate3} style={{ minWidth: "8rem" }} />
