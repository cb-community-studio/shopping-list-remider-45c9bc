...
const UsersDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    ...
    const tickTemplate3 = (rowData, { rowIndex }) => <i className={`pi ${rowData.isAdmin?"pi-check": "pi-times"}`}  ></i>
    ...
    return (
        <DataTable value={items} onRowClick={onRowClick} scrollable rowHover paginator rows={10}>
            ...
            <Column field="isAdmin" header="am the Boss" body={tickTemplate3} style={{ minWidth: "8rem" }} />
            <Column field="remark" header="remark" body={pTemplate4} style={{ minWidth: "8rem" }} />
